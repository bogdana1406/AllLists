...
public class FileAttributor {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Data modified " + Files.getLastModifiedTime(path));
...
//        Files.createFile(Paths.get("file1.txt"), fileAttributes);
        ...
        UserPrincipal user = path.getFileSystem().getUserPrincipalLookupService().lookupPrincipalByName("bogdana");
